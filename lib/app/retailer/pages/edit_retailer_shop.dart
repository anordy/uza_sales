...
class EditRetailerShop extends StatefulWidget {
  const EditRetailerShop({Key key}) : super(key: key);

  @override
  _EditRetailerShopState createState() => _EditRetailerShopState();
}

class _EditRetailerShopState extends State<EditRetailerShop> {
  String phone;
  String accessToken;
  String address;
  String shopName;
                ...
                child: Center(
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                          hintText: "Enter shopkeeper name",
                          border: InputBorder.none,
                          hintStyle: TextStyle(
