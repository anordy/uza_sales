...
class CustomPayLaterToast extends StatefulWidget {
  final String ok, desc;
  final Function okChange, cancelChange;

  const CustomPayLaterToast(
      {Key key,
      @required this.ok,
      @required this.desc,
...
class _CustomToastState extends State<CustomPayLaterToast> {
              ...
              children: <Widget>[
                Row(
                  children: [
                    ...
                    Text(
                      "Success",
                      style: TextStyle(color: AppColor.success, fontSize: 24),
                    ),
                  ],
                ),
                SizedBox(
