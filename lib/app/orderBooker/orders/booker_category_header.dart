...
import 'package:uza_sales/app/orderBooker/orders/booker_category_items.dart';
import 'package:uza_sales/app/orderBooker/orders/booker_subcategory_items.dart';
...
class BookerCategoryHeader extends StatelessWidget {
  final Color backgroundColor;
  final String headerTitle;
  final Widget filter;

  BookerCategoryHeader(this.backgroundColor, this.headerTitle, this.filter);
