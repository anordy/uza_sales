...
class BookerPOSMScreen extends StatefulWidget {
  const BookerPOSMScreen({Key key}) : super(key: key);

  @override
  _BookerCreateShopState createState() => _BookerCreateShopState();
}

class _BookerCreateShopState extends State<BookerPOSMScreen>
  ...
  String status;
  final statuses = ['active', 'in active'];
  File _image;
              ...
              children: [
                            ...
                            suffixIcon: IconButton(
                              ...
                              onPressed: () {
                                showModalBottomSheet(
                                    ...
                                    context: context,
                                    builder: (context) => showStoreLists());
                              },
                            ),
                            hintText: "Choose Shop Name",
                ...
                Container(
                  ...
                  child: Center(
                    ...
                    items: statuses.map(buildMenuItem).toList(),
                    style: TextStyle(color: Colors.black45, fontSize: 16),
                  )))),
                ),
                SizedBox(
...
// show store lists
                  ...
                  child: Column(
                    children: [
                      ...
                      ListTile(
                        ...
                        subtitle: Text(
                          'Palm village Mikocheni A Dar es salaam',
  ...
  //  product Cards
  Widget _buidCard(String name, String isFavourite, int index, context) {
    return Padding(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                height: Utils.displayHeight(context) * 0.007,
              ),
              Padding(
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    text: name,
                    style: TextStyle(
                        fontSize: Utils.displayWidth(context) * 0.03,
                        fontWeight: FontWeight.w600,
                        color: Color(0xFF5A5A5A)),
                  ),
                ),
