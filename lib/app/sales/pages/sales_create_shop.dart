...
class SalesCreateShop extends StatefulWidget {
  const SalesCreateShop({Key key}) : super(key: key);

  @override
  _SalesCreateShopState createState() => _SalesCreateShopState();
}

class _SalesCreateShopState extends State<SalesCreateShop>
