...
class CreditOrderDialog extends StatefulWidget {
  final Order order;
  final String cancel, ok, desc;
  final Function okChange, cancelChange;

  const CreditOrderDialog(
      {Key key,
...
class _ComfirmDialogState extends State<CreditOrderDialog> {
              ...
              children: <Widget>[
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        "Thanks For using Credit with Us!",
                        style: TextStyle(
                            color: Colors.black,
                            fontSize: 15,
                ...
                MaterialButton(
                    ...
                    onPressed: () {
                      _orderProvider.payCash(
                          ...
                          creditedAmount: this.widget.order.orderTotal);
